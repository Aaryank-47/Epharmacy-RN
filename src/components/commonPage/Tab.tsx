...
const ProfileTabIcon = memo<{
  ...
  const profileImageUrl = useMemo(() => {
    ...
    if (
      Array.isArray(userData.profileImage) &&
      userData.profileImage.length > 0
    )
      return userData.profileImage[0];
  ...
  if (!userData) {
    return (
      ...
      >
        <Text
          style={{ fontWeight: 'bold', color: 'white', fontSize: size * 0.4 }}
        >
          ?
        </Text>
      </View>
...
const TabBar = memo<{
  ...
  ({
    ...
    const gradientColors = useMemo(
      () => (isDark ? ['#0F1419', '#292929'] : ['#F3F4F6', '#F9FAFB']),
      [isDark],
    );
              ...
              >
                {currentTab.isProfile ? (
                  ...
                  <RotatingCompassIcon
                    isActive={isActive}
                    color={activeColor}
                    size={Math.min(screenWidth * 0.074, 36)}
                  />
                ) : (
                  <Icon
                ...
                <Text
                  ...
                  numberOfLines={1}
                >
                  {currentTab.isProfile && userData.name
      ...
      <View style={{ flex: 1, backgroundColor: surfaceColor }}>
        ...
        <QROptionsBottomSheet
          ...
          onHistory={() => {
            ...
            Alert.alert('History', 'Scan history feature is coming soon!');
          }}
          onTakePhoto={async () => {
            setShowQRSheet(false);
            ...
            (navigation as any).navigate('OCRProcessingScreen', { file });
          }}
